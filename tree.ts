...
// --- CONFIGURATION ---
const CONFIG = {
    photoOnly: true, // If true, only generate a final image
    width: 1080, 
    height: 1080,
    fps: 30, 
    durationSeconds: 30, // Slightly longer for the detailed growth
    seed: randomBytes(16).toString('hex'), // Random seed for unique tree", 
    filename: "pretty_bonsai.webm",
...
async function generateVideo() {
    ...
    if (CONFIG.photoOnly) {
        ...
        fs.writeFileSync("img.png", finalBuffer);
